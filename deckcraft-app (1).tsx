...
export default function App() {
    ...
    /**
     * Enhanced image generation with mock demo capability
     */
    const generateImageWithHuggingFace = async (prompt, subjectName) => {
        ...
        /* 
        // PRODUCTION CODE - Uncomment when ready to use real API
        try {
                ...
                body: JSON.stringify({
                    inputs: `
                        **SKATEBOARD DECK DESIGN**
                        ...
                        Create a vertical skateboard deck artwork with these specifications:
                        
                        **Subject & Scene:** ${prompt}
                        
                        **Technical Requirements:**
                        - Aspect ratio: 8.25:32 inches (skateboard deck proportions)
                        - Vertical orientation, tall and narrow
                        - High resolution, vibrant colors
                        - Clean, bold linework in the style of classic skateboard graphics
                        
                        **Composition Guidelines:**
                        - Design flows naturally from top to bottom
                        - Clear visual hierarchy with foreground, midground, background
                        - Balanced composition that works within skateboard deck shape
                        - Leave space at very bottom for text placement
                        
                        **Art Style:**
                        - Bold, high-contrast colors
                        - Dynamic skateboard art aesthetic
                        - Clean vector-like appearance
                        - Professional skateboard graphic design quality
                        
                        **Content Restrictions:**
                        - Minimal text (only "${subjectName}" at bottom if any)
                        - No copyrighted logos or brands
                        - Family-friendly content
                        - Focus on artistic interpretation rather than photorealism
                    `,
                    parameters: {
                        width: 512,
                        height: 1536, // Skateboard deck aspect ratio
    ...
    const handleGenerate = useCallback(async (isVariation = false) => {
        ...
        try {
            const generatedUrl = await generateImageWithHuggingFace(detailedPrompt, subject);
